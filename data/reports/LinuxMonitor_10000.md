...
| Output | `0.0` | `6829.176117248162` | `8576.924490792437` |
...
|--------------|-------------|----------|----------|----------|
| kafka_cluster_cp_kafka_0 | `6.0` | `0.0` | `0.3615357829761905` | `2.9364283833333333` |
| kafka_cluster_cp_kafka_1 | `6.0` | `0.0` | `0.22048556615079365` | `1.7814835833333333` |
| kafka_cluster_cp_kafka_2 | `6.0` | `0.0` | `0.19642745202380954` | `1.577254516666667` |

### Kafka Cluster Pods Memory (%)

| Component | Allocated | Min (%) | Avg (%) | Max (%) |
|--------------|-------------|----------|----------|----------|
| kafka_cluster_cp_kafka_0 | `16.0` | `0.0` | `6.140249967575073` | `54.77902889251709` |
| kafka_cluster_cp_kafka_1 | `16.0` | `0.0` | `10.320962043035598` | `99.99833106994629` |
| kafka_cluster_cp_kafka_2 | `16.0` | `0.0` | `9.597944191523961` | `98.78261089324951` |

### ClickHouse Pods CPU (%)

| Component | Allocated | Min (%) | Avg (%) | Max (%) |
|--------------|-------------|----------|----------|----------|
| chi_clickhouse_vusmart_0_0_0 | `9.0` | `0.0` | `1.1912808678306879` | `12.579218444444443` |
| chi_clickhouse_vusmart_0_1_0 | `9.0` | `0.0` | `0.590107922010582` | `89.42375881111111` |

### ClickHouse Pods Memory (%)

| Component | Allocated | Min (%) | Avg (%) | Max (%) |
|--------------|-------------|----------|----------|----------|
| chi_clickhouse_vusmart_0_0_0 | `34.0` | `0.0` | `7.357395930784424` | `55.38654327392578` |
| chi_clickhouse_vusmart_0_1_0 | `34.0` | `0.0` | `1.370037971090536` | `13.751602172851562` |
...
|--------------|-------------|----------|----------|----------|
| `linuxmonitor` | `1.0` | `0.0` | `12.136297101428571` | `99.8493866` |

### Pipeline Pod Memory (%)

| Pipeline Name | Allocated | Min (%) | Avg (%) | Max (%) |
|--------------|-------------|----------|----------|----------|
| `linuxmonitor` | `0.48828125` | `0.0` | `9.50377232142857` | `105.28437500000001` |
