...
|--------------|-------------|----------|----------|----------|
| kafka_cluster_cp_kafka_0 | `6.0` | `0.0` | `0.3725891734920635` | `4.224661316666667` |
| kafka_cluster_cp_kafka_1 | `6.0` | `0.0` | `0.27731855746031747` | `2.8173356333333333` |
| kafka_cluster_cp_kafka_2 | `6.0` | `0.0` | `0.5270333723809524` | `5.888412266666667` |

### Kafka Cluster Pods Memory (%)

| Component | Allocated | Min (%) | Avg (%) | Max (%) |
|--------------|-------------|----------|----------|----------|
| kafka_cluster_cp_kafka_0 | `16.0` | `0.0` | `10.837749867212205` | `99.98979568481445` |
| kafka_cluster_cp_kafka_1 | `16.0` | `0.0` | `13.232266846157255` | `99.99797344207764` |
| kafka_cluster_cp_kafka_2 | `16.0` | `0.0` | `14.06621081488473` | `99.9981164932251` |

### ClickHouse Pods CPU (%)

| Component | Allocated | Min (%) | Avg (%) | Max (%) |
|--------------|-------------|----------|----------|----------|
| chi_clickhouse_vusmart_0_0_0 | `9.0` | `0.0` | `1.6937921063492063` | `28.857065922222226` |
| chi_clickhouse_vusmart_0_1_0 | `9.0` | `0.0` | `0.6300941116666667` | `9.300692044444443` |

### ClickHouse Pods Memory (%)

| Component | Allocated | Min (%) | Avg (%) | Max (%) |
|--------------|-------------|----------|----------|----------|
| chi_clickhouse_vusmart_0_0_0 | `34.0` | `0.0` | `10.290517379589776` | `80.19507913028492` |
| chi_clickhouse_vusmart_0_1_0 | `34.0` | `0.0` | `3.6918022786201874` | `29.992193334242877` |
...
|--------------|-------------|----------|----------|----------|
| `kubernetes-metrics` | `1.0` | `0.0` | `11.0687523291632` | `100.56576700000002` |

### Pipeline Pod Memory (%)

| Pipeline Name | Allocated | Min (%) | Avg (%) | Max (%) |
|--------------|-------------|----------|----------|----------|
| `kubernetes-metrics` | `0.48828125` | `0.0` | `12.576281278895053` | `110.77656250000001` |
